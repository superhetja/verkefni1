...
class ShowPrice(Ui):
    ...
    def show_price_list(self):
        ...
        print('Price for Standard car: {}'.format(self.STANDARD))
        ...
        print('Price for Standard car: {}'.format(self.__service.calculate_pricelist(self.STANDARD, self.CARSTANDARD))
